...
class CrossAttention(Attention):
    """
    """
    def forward(self, source: Tensor, target: Tensor, source_mask: Tensor, target_mask: Tensor) -> Tuple[Tensor, Tensor]:
        return self._forward(source, source, target, source_mask, target_mask)
